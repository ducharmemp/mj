...
pub fn main() -> Result<(), Box<dyn Error>> {
    ...
    let event_loop: EventLoop<Scene> = EventLoop::with_user_event().build()?;
...
fn add_shapes_to_scene(scene: &mut Scene) {
    ...
    let rect = RoundedRect::new(10.0, 10.0, 240.0, 240.0, 0.0);
